...
from app.services.nba import get_lineups, lookup_lineup, _LINEUP_SORT, SEASON_TYPES
...
def lineups(
    ...
    return get_lineups(season, group_quantity, sort_by, limit, SEASON_TYPES[season_type])
...
def lineup_lookup(
    ...
    return lookup_lineup(season, ids, SEASON_TYPES[season_type])
